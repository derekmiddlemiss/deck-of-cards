...
class AceHighCardComparator implements Comparator<Card> {

    private static int maxCardValueOrdinal = CardValue.values()[CardValue.values().length - 1].ordinal();
    private static int effectiveAceOrdinal = maxCardValueOrdinal + 1;
